            ...
            <section id='home-header'>
                ...
                <div className='home-container'>
                    <section id='home-features'>
                        <div>
                            <p>
                                ResumeRangers uses the power of Open AI's Chat GPT and simple yet stylistic templates to help make the resume and cover letter building process hassle free. Get high quality answers from Chat GPT, tailored to your job and experience - never run into a blank again when writing! The builder features many free templates and the ability to export your finished product to PDF.
